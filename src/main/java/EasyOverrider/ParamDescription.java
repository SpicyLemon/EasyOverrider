 ...
 * <li><code>String name</code> - This is the name of the parameter (usually the variable name).</li>
 * <li><code>Function getter</code> - This is a reference to the getter for the parameter.</li>
 * <li>{@link ParamMethodRestriction}<code> paramMethodRestriction</code> - This is used to describe what method calls this parameter should be included in.</li>
 ...
 * so as to not call back to the object being described in here.</li>
 *
...
public interface ParamDescription<O, P, E> {
    ...
    /**
     * Gets the {@link ParamMethodRestriction} for this parameter.
     * @return a ParamMethodRestriction value.
     */
     ...
     * @return A reference to the toString(boolean) method needed.
     */
    ...
    /**
     * Get the String of this parameter from the provided object. If the parameter is null, "null" is returned.
     ...
     * @param obj The object to get the parameter from. Cannot be null.
     * @param preventingRecursion Flag for whether or not we're trying to prevent recursion on this parameter.
    ...
    /**
     * Gets the name/value string for this parameter given the provided object.
